...
public class PerformanceInprovementUsingBatching_05 {
    public static void main(String[] args) throws IOException {
        ...
        Logger logger = LoggerFactory.getLogger(PerformanceInprovementUsingBatching_05.class.getName());
...
//             =========================
                /*
                TO make this Idempotent we have two strategy:
                This provided Id will make Idempotent which is prevent the duplicate message
...
/*
            ...
            //After adding all the request to the bulk request now we want to
            // sent them to the elasticsearch through BulkResponse

           if(recordCount > 0) { // send this if there is a record(s)
